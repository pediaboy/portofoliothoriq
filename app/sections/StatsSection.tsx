...
const testimonials = [
  { name: 'Ahmad Fauzi', role: 'Trader Saham', avatar: 'AF', text: 'Sistem analisa yang dibangun benar-benar membantu keputusan trading saya. Sangat profesional dan detail.', color: '#00d4ff' },
  { name: 'Rina Wulandari', role: 'Business Owner', avatar: 'RW', text: 'Website yang dibuat melampaui ekspektasi. Desainnya premium dan performa loading sangat cepat.', color: '#7c3aed' },
  { name: 'Dimas Prasetyo', role: 'Startup Founder', avatar: 'DP', text: 'Thirafi sangat paham kebutuhan bisnis. Dashboard yang dibuat sangat membantu monitoring operasional kami.', color: '#10b981' },
]
      ...
      <section className="relative py-20">
        <div className="max-w-7xl mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, amount: 0.3 }} className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {testimonials.map((t, i) => (
              <motion.div key={t.name}
                ...
                <div className="text-4xl mb-4 opacity-30" style={{ color: t.color }}>&ldquo;</div>
